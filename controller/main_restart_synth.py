...
def infinite_run(sample_type):
    ...
    count = 0
    while succ_ids:
        filename = "./[plasynth-synth-infinite]%s_diffvector_score40_%d.json" % (sample_type,count)
...
def run(synthesis_module_type, sample_type,t):
    ...
    filename = "restart_result/msynth/220912_msynth-synth_T-luby_FT60_beta(%d).json" % (t)
